<header class="top-bar asee-header">
        ...
        <ul class="dropdown medium-horizontal menu" data-dropdown-menu>
            ...
            <li class="asee-menu-option">
                ...
                <ul class="menu vertical">
                    <li class="asee-menu-option"><a href="#">Using Sources</a></li>
                    <li class="asee-menu-option"><a href="#">Punctuation</a></li>
                    <li class="asee-menu-option"><a href="#">Visuals</a></li>
                </ul>
            </li>
        </ul>
    </div>
